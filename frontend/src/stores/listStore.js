...
export const useListStore = defineStore('list', () => {
  ...
  // State for Help Sidebar (default true, can be closed)
  ...
  return {
    ...
    isHelpSidebarOpen, // Exported state
    isAddingItem, activeList, groupedItems, totals,
    ...
    toggleChat, closeChat, toggleHelpSidebar, sendMessage,
    syncPendingActions
  }
})
